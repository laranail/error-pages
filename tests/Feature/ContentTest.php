...
it('resolves content in the configured default locale', function (): void {
    app('translator')->addLines(['errors.404.title' => 'Introuvable'], 'fr', 'laranail-error-pages');
...
it('falls back to the ambient locale when no default is configured', function (): void {
    app('translator')->addLines(['errors.404.title' => 'No encontrada'], 'es', 'laranail-error-pages');
