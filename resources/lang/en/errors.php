...
return [
    ...
    '401' => ['title' => 'Unauthorized', 'message' => 'You need to sign in to view this page.'],
    '402' => ['title' => 'Payment required', 'message' => 'This resource requires a payment to access.'],
    ...
    '503' => ['title' => 'Be right back', 'message' => 'We are briefly offline for maintenance. Please try again in a few minutes.'],
    '504' => ['title' => 'Gateway timeout', 'message' => 'The server took too long to respond. Please try again shortly.'],
    '4xx' => ['title' => 'This page is unavailable', 'message' => 'The page could not be displayed. Please check the address and try again.'],
    '5xx' => ['title' => 'Something went wrong', 'message' => 'An unexpected error occurred on our side. Please try again shortly.'],
];
